...
class StatoscopeWebpackPlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.done.tapAsync({ stage: exports.STATOSCOPE_STAGE_COMPILER_DONE, name: pluginName }, async (stats, cb) => {
            ...
            try {
                await Promise.all([
                    (_b = htmlReport.writer) === null || _b === void 0 ? void 0 : _b.write(),
    ...
    makeReport(outputPath, stats) {
        ...
        const writer = new report_writer_1.default({
        ...
        for (const { filename, stream } of stats) {
            writer.addChunkWriter(stream, path_1.default.basename(filename));
        }
